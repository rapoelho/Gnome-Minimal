...
## Instalando alguns extras
	...
	sleep 2
	pacman -S --noconfirm webp-pixbuf-loader gnome-software sushi gnome-system-monitor gnome-disk-utility baobab
}

flatpakExtraGnome () {
	echo -e "\nInstalando alguns Extras:\n	- Meteorologia\n	- Relógio\n	- Calendário"
	sleep 2
	flatpak install -y --noninteractive org.gnome.Weather org.gnome.clocks org.gnome.Calendar
	
	echo -e "\nInstalando os Wallpapers do Gnome\n"
	sleep 2
